...
import kaulua.formatting.FormattingService;
...
public abstract class AbstractFormattingJsonRPC implements IFormatting {
  @Inject
  @Extension
  ...
  public CompletableFuture<List<? extends TextEdit>> formatting(final DocumentFormattingParams params) {
    ...
    final Supplier<List<? extends TextEdit>> _function = () -> {
      return this.formattingService.format(document, mockResource, params, CancelIndicator.NullImpl);
    };
    return CompletableFuture.<List<? extends TextEdit>>supplyAsync(_function);
  }
