// Class: io/quarkus/deployment/steps/UndertowWebsocketProcessor$setupWorker61
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowWebsocketProcessor$setupWorker61#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/undertow/websockets/runtime/UndertowWebsocketRecorder#setupWorker
    RETURN
    ** label2
