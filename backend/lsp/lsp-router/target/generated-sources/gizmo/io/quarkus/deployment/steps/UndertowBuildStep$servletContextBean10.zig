// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean10
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean10#deploy_0
    RETURN
    ** label2
