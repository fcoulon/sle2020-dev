// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit7
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit7#deploy_0
    RETURN
    ** label2
