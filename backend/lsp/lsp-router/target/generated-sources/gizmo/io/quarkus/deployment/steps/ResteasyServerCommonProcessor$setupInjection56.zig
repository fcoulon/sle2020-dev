// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection56
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection56#deploy_0
    RETURN
    ** label2
