// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean11
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean11#deploy_0
    RETURN
    ** label2
