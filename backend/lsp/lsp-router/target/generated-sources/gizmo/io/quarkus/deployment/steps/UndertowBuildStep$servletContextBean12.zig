// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean12
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean12#deploy_0
    RETURN
    ** label2
