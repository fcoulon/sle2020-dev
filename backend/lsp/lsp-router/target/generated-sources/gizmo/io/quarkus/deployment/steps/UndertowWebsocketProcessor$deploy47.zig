// Class: io/quarkus/deployment/steps/UndertowWebsocketProcessor$deploy47
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowWebsocketProcessor$deploy47#deploy_0
    RETURN
    ** label2
