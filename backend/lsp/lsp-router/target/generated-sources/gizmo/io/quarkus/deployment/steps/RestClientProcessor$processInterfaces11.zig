// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces11
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces11#deploy_0
    RETURN
    ** label2
