// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean46
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean46#deploy_0
    RETURN
    ** label2
