// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces45
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces45#deploy_0
    RETURN
    ** label2
