// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties53
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties53#deploy_0
    RETURN
    ** label2
