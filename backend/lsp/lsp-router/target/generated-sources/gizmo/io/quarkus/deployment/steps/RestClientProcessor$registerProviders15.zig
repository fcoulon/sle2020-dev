// Class: io/quarkus/deployment/steps/RestClientProcessor$registerProviders15
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$registerProviders15#deploy_0
    RETURN
    ** label2
