// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection55
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection55#deploy_0
    RETURN
    ** label2
