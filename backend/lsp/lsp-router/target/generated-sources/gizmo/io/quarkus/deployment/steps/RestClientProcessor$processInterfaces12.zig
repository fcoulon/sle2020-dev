// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces12
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces12#deploy_0
    RETURN
    ** label2
