// Class: io/quarkus/deployment/steps/UndertowWebsocketProcessor$setupWorker25
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowWebsocketProcessor$setupWorker25#deploy_0
    RETURN
    ** label2
