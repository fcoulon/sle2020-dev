// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent62
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent62#deploy_0
    RETURN
    ** label2
