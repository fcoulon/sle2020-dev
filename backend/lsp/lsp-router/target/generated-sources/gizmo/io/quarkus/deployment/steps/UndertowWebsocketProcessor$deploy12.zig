// Class: io/quarkus/deployment/steps/UndertowWebsocketProcessor$deploy12
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowWebsocketProcessor$deploy12#deploy_0
    RETURN
    ** label2
