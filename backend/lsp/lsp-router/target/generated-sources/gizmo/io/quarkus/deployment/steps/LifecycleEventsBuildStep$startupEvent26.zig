// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent26
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent26#deploy_0
    RETURN
    ** label2
