// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties54
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties54#deploy_0
    RETURN
    ** label2
