// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces9
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces9#deploy_0
    RETURN
    ** label2
