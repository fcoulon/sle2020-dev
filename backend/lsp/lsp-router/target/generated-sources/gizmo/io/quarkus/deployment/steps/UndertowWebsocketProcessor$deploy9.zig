// Class: io/quarkus/deployment/steps/UndertowWebsocketProcessor$deploy9
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowWebsocketProcessor$deploy9#deploy_0
    RETURN
    ** label2
