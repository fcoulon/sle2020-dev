// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties19
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties19#deploy_0
    RETURN
    ** label2
