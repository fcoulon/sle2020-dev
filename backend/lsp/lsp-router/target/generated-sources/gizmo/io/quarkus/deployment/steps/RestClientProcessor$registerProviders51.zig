// Class: io/quarkus/deployment/steps/RestClientProcessor$registerProviders51
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$registerProviders51#deploy_0
    RETURN
    ** label2
