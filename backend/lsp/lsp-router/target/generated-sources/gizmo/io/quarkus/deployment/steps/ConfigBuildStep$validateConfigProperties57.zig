// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties57
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties57#deploy_0
    RETURN
    ** label2
