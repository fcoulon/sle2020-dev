// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces44
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces44#deploy_0
    RETURN
    ** label2
