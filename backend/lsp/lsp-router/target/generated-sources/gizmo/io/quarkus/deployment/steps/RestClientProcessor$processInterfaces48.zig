// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces48
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces48#deploy_0
    RETURN
    ** label2
