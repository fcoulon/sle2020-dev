...
public class MiniJavaTypeComputer {
  ...
  public static final org.tetrabox.minijava.xtext.miniJava.Class STRING_TYPE = ObjectExtensions.<org.tetrabox.minijava.xtext.miniJava.Class>operator_doubleArrow(MiniJavaTypeComputer.factory.createClass(), ((Procedure1<org.tetrabox.minijava.xtext.miniJava.Class>) (org.tetrabox.minijava.xtext.miniJava.Class it) -> {
    it.setName("stringType");
  }));
  
  public static final org.tetrabox.minijava.xtext.miniJava.Class INT_TYPE = ObjectExtensions.<org.tetrabox.minijava.xtext.miniJava.Class>operator_doubleArrow(MiniJavaTypeComputer.factory.createClass(), ((Procedure1<org.tetrabox.minijava.xtext.miniJava.Class>) (org.tetrabox.minijava.xtext.miniJava.Class it) -> {
    it.setName("intType");
  }));
  
  public static final org.tetrabox.minijava.xtext.miniJava.Class BOOLEAN_TYPE = ObjectExtensions.<org.tetrabox.minijava.xtext.miniJava.Class>operator_doubleArrow(MiniJavaTypeComputer.factory.createClass(), ((Procedure1<org.tetrabox.minijava.xtext.miniJava.Class>) (org.tetrabox.minijava.xtext.miniJava.Class it) -> {
    it.setName("booleanType");
  }));
  
  public static final org.tetrabox.minijava.xtext.miniJava.Class NULL_TYPE = ObjectExtensions.<org.tetrabox.minijava.xtext.miniJava.Class>operator_doubleArrow(MiniJavaTypeComputer.factory.createClass(), ((Procedure1<org.tetrabox.minijava.xtext.miniJava.Class>) (org.tetrabox.minijava.xtext.miniJava.Class it) -> {
    it.setName("nullType");
  }));
  ...
  public TypeDeclaration typeFor(final Expression e) {
    ...
    if (!_matched) {
      if (e instanceof This) {
        _matched=true;
        _switchResult = EcoreUtil2.<org.tetrabox.minijava.xtext.miniJava.Class>getContainerOfType(e, org.tetrabox.minijava.xtext.miniJava.Class.class);
      }
    }
    if (!_matched) {
      if (e instanceof Super) {
        _matched=true;
        _switchResult = EcoreUtil2.<org.tetrabox.minijava.xtext.miniJava.Class>getContainerOfType(e, org.tetrabox.minijava.xtext.miniJava.Class.class).getSuperClass();
      }
    }
    if (!_matched) {
