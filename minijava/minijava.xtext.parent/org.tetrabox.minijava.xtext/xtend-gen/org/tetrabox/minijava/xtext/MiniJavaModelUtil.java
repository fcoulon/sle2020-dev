...
public class MiniJavaModelUtil {
  protected Iterable<Field> _fields(final org.tetrabox.minijava.xtext.miniJava.Class c) {
  ...
  public Set<TypeDeclaration> getSuperTypes(final TypeDeclaration c) {
    ...
    if ((c instanceof org.tetrabox.minijava.xtext.miniJava.Class)) {
      org.tetrabox.minijava.xtext.miniJava.Class _superClass = ((org.tetrabox.minijava.xtext.miniJava.Class)c).getSuperClass();
      boolean _tripleNotEquals = (_superClass != null);
      if (_tripleNotEquals) {
        current.add(((org.tetrabox.minijava.xtext.miniJava.Class)c).getSuperClass());
      }
    }
  ...
  public Iterable<Field> fields(final TypeDeclaration c) {
    if (c instanceof org.tetrabox.minijava.xtext.miniJava.Class) {
      return _fields((org.tetrabox.minijava.xtext.miniJava.Class)c);
